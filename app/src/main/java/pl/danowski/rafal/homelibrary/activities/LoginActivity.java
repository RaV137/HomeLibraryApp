...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView mEmailOrPasswordView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailOrPasswordView = findViewById(R.id.email);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mEmailOrPasswordView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        // Reset errors.
        mEmailOrPasswordView.setError(null);
        mPasswordView.setError(null);

        // Store values at the time of the login attempt.
        String email = mEmailOrPasswordView.getText().toString();
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailOrPasswordView.setError(getString(R.string.error_field_required));
            focusView = mEmailOrPasswordView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            mEmailOrPasswordView.setError(getString(R.string.error_invalid_email));
            focusView = mEmailOrPasswordView;
            cancel = true;
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        mEmailOrPasswordView.setAdapter(adapter);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String loginOrEmail, String password) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            LoginResult loginResult = loginRegistrationController.attemptLogin(loginOrEmail, mPassword);
